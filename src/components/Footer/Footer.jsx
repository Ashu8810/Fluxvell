    ...
    <footer className="vrm-footer">
      <div className="vrm-footer-grid">
        ...
        <div className="vrm-footer-col">
          ...
          <Link to="#" className="vrm-footer-link">Third-Party Risk Management</Link>
          <Link to="#" className="vrm-footer-link">Brand Reputation Management</Link>
          <Link to="#" className="vrm-footer-link">Operational Risk Management</Link>
          <Link to="#" className="vrm-footer-link">Dark Web Surveillance</Link>
          <Link to="#" className="vrm-footer-link">Cyber Insurance</Link>
        </div>
